class ZCL_ZRFC_SERVICE_DPC definition
  public
...
protected section.
  ...
  methods BOOKINGCONFIRMAT_CREATE_ENTITY
    ...
    exporting
      !ER_ENTITY type ZCL_ZRFC_SERVICE_MPC=>TS_BOOKINGCONFIRMATION
    raising
  ...
  methods BOOKINGCONFIRMAT_GET_ENTITYSET
    ...
    exporting
      !ET_ENTITYSET type ZCL_ZRFC_SERVICE_MPC=>TT_BOOKINGCONFIRMATION
  ...
  methods DEPARTURESSET_CREATE_ENTITY
    importing
      ...
      !IO_DATA_PROVIDER type ref to /IWBEP/IF_MGW_ENTRY_PROVIDER optional
    exporting
      !ER_ENTITY type ZCL_ZRFC_SERVICE_MPC=>TS_DEPARTURES
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
  ...
  methods DEPARTURESSET_GET_ENTITYSET
    importing
      ...
      !IO_TECH_REQUEST_CONTEXT type ref to /IWBEP/IF_MGW_REQ_ENTITYSET optional
    exporting
      !ET_ENTITYSET type ZCL_ZRFC_SERVICE_MPC=>TT_DEPARTURES
      !ES_RESPONSE_CONTEXT type /IWBEP/IF_MGW_APPL_SRV_RUNTIME=>TY_S_MGW_RESPONSE_CONTEXT
    raising
      /IWBEP/CX_MGW_BUSI_EXCEPTION
      /IWBEP/CX_MGW_TECH_EXCEPTION .
...
CLASS ZCL_ZRFC_SERVICE_DPC IMPLEMENTATION.


  method /IWBEP/IF_MGW_APPL_SRV_RUNTIME~CREATE_ENTITY.
*&----------------------------------------------------------------------------------------------*
*&  Include           /IWBEP/DPC_TEMP_CRT_ENTITY_BASE
*&* This class has been generated on 30.05.2021 17:57:59 in client 001
*&*
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA bookingconfirmat_create_entity TYPE zcl_zrfc_service_mpc=>ts_bookingconfirmation.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA bookingconfirmat_get_entity TYPE zcl_zrfc_service_mpc=>ts_bookingconfirmation.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA bookingconfirmat_get_entityset TYPE zcl_zrfc_service_mpc=>tt_bookingconfirmation.
 DATA lv_entityset_name TYPE string.
...
*&-----------------------------------------------------------------------------------------------*
 ...
 DATA bookingconfirmat_update_entity TYPE zcl_zrfc_service_mpc=>ts_bookingconfirmation.
 DATA lv_entityset_name TYPE string.
 DATA lr_entity TYPE REF TO data. "#EC NEEDED
...
* Datendeklaration
*-------------------------------------------------------------
 DATA airlineid TYPE zif_bapi_flbooking_confirm1=>bapisbokey-airlineid.
 DATA bookingnumber TYPE zif_bapi_flbooking_confirm1=>bapisbokey-bookingid.
 DATA return  TYPE zif_bapi_flbooking_confirm1=>__bapiret2.
 DATA ls_return  TYPE LINE OF zif_bapi_flbooking_confirm1=>__bapiret2.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
 DATA lx_root TYPE REF TO cx_root.
 DATA ls_request_input_data TYPE zcl_zrfc_service_mpc=>ts_bookingconfirmation.
...
*-------------------------------------------------------------
 DATA date TYPE dats.
 DATA airport TYPE zif_zget_departures_airport=>zairport.
 DATA departures  TYPE zif_zget_departures_airport=>zflight_plan_t.
 DATA ls_departures  TYPE LINE OF zif_zget_departures_airport=>zflight_plan_t.
 DATA lv_rfc_name TYPE tfdir-funcname.
 DATA lv_destination TYPE rfcdest.
 DATA lv_subrc TYPE syst-subrc.
 DATA lv_exc_msg TYPE /iwbep/mgw_bop_rfc_excep_text.
