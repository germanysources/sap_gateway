class ZCL_ZFLIGHT_MODEL2_MPC definition
  public
...
CLASS ZCL_ZFLIGHT_MODEL2_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZFLIGHT_MODEL2_SRV' ).
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20210213120609'.                  "#EC NOTEXT
